...
#Minimum time to stay active and still meet the devices hold"
set flash_min_delay_out           [expr $data_tracemin - $Th - \
                                         $clk_tracemax ]
#"Maximum time to arrive and still meet the device's Tsu"
set flash_max_delay_out           [expr $data_tracemax + $Tsu - \
                                         $clk_tracemin]
                                         
#"Minimum time to stay active and still meet Th"

set flash_min_delay_in           [expr $data_tracemin + $tcomin - \
                                        $clk_tracemax]
                                        
#"Maximum time to arrive and still meet Tsu"
set flash_max_delay_in           [expr $data_tracemax + $tcomax - \
                                        $clk_tracemin]
