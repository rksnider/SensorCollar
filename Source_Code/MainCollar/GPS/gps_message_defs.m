...
%   Field Definitions for UBX-TIM-TP Time Pulse Data message.

ubx_tim_tp      = {'towMS'      4 1 ;   ...
                   'towSubMS'   4 1 ;   ...
                   'qErr'       4 1 ;   ...
                   'week'       2 1 ;   ...
                   'flags'      1 1 ;   ...
...
%   Text message cannot be controlled with via message rate.
% msg_info      = {'msgClass'   1 240 ;   ...
                 % 'msgID'      1 65  ;   ...
                 % 'rate'       6 0   } ;
...
%   Autogenerate navigation solution messages.

msg_info      = {'msgClass'   1 1   ;   ...
                 'msgID'      1 6   ;   ...
                 'rate'       6 256 } ;

msg_id        = [6 1] ;
msg_name      = 'msg_ubx_cfg_msg_ubx_nav_sol' ;

mem_info      = gps_init_out (miffile, mem_info, 0, msg_name, msg_id,   ...
                              msg_info) ;


%   Autogenerate time mark messages.

msg_info      = {'msgClass'   1 13  ;   ...
                 'msgID'      1 3   ;   ...
                 'rate'       6 256 } ;

msg_id        = [6 1] ;
msg_name      = 'msg_ubx_cfg_msg_ubx_tim_tm2' ;

mem_info      = gps_init_out (miffile, mem_info, 0, msg_name, msg_id,   ...
                              msg_info) ;


%   Autogenerate time pulse messages.  The timepluse rate is set low
%   enough to insure that a timepulse packet will be received before its
%   timepulse is received no matter how much packet data is already in the
%   GPS buffers.
...
msg_id        = [6 1] ;
msg_name      = 'msg_ubx_cfg_msg_ubx_tim_tp' ;
...
msg_info      = {'tpIdx'              1 0       ;   ...
                 ...
                 'freqPeriodLock'     4 tp_rate*1000000 ;   ...
                 'pulseLenRatio'      4 0       ;   ...
...
msg_id        = [6 71] ;
msg_name      = 'msg_ubx_cfg_logfilter' ;

mem_info      = gps_init_out (miffile, mem_info, 0, msg_name, msg_id,   ...
                              msg_info) ;

%   Save the configuration in battery backed-up RAM.

msg_info      = {'clearMask'          4 0       ;   ...
                 'saveMask'           4 2079    ;   ...
                 'loadMask'           4 0       ;   ...
                 'deviceMask'         1 1       } ;

msg_id        = [6 9] ;
msg_name      = 'msg_ubx_cfg_cfg' ;

mem_info      = gps_init_out (miffile, mem_info, 1, msg_name, msg_id,   ...
                              msg_info) ;

%   Set Receiver Power Management to Continuous mode after waking up the
%   GPS.  Time pulse is activated as this also activates time mark
%   capability.

init_addr_2   = mem_info (1) ;
...
%   Set Receiver Power Management to Power Save mode and turn off time
%   pulses.

init_addr_3   = mem_info (1) ;
...
romseg_addr   = [tree_addr lookup_addr msgno_addr                       ...
                 init_addr_1 init_addr_2 init_addr_3] ;
