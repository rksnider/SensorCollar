#   JTAG Timing information.
#   Perform data constraining at the pins.
#   This file comes from Altera Quartus' Timequest Cookbook.

puts $sdc_log "Currently in JTAG_dev.sdc\n"
...
proc set_jtag_timing_constraints { } {
  ...
  if { $use_fitter_specific_constraint && \
       [string equal quartus_fit $::TimeQuestInfo(nameofexecutable)] } {
...
proc set_default_quartus_fit_timing_directive { } {
  ...
  create_clock -name {altera_reserved_tck} \
               -period $jtag_33Mhz_t_period [get_ports {altera_reserved_tck}]
...
proc set_jtag_timing_spec_for_timing_analysis { } {
  ...
  set tdi_is_driven_by_blaster        0
  ...
  set_false_path -from [get_ports {altera_reserved_tdi}] \
                 -to   [get_ports {altera_reserved_tdo}]
  set_false_path -from [get_registers *~jtag_reg] \
                 -to   [get_ports {altera_reserved_tdo}]
}
...
proc set_tms_timing_spec { } {
  ...
  set tms_in_max                [expr $tms_cable_max        + \
                                      $tms_header_trace_max + \
                                      $tms_blaster_tco_max  - \
                                      [get_tck_delay_min]]
  set tms_in_min                [expr $tms_cable_min        + \
                                      $tms_header_trace_min + \
                                      $tms_blaster_tco_min  - \
                                      [get_tck_delay_max]]

  set_input_delay -add_delay -clock_fall -clock altera_reserved_tck     \
                  -max $tms_in_max [get_ports {altera_reserved_tms}]
  set_input_delay -add_delay -clock_fall -clock altera_reserved_tck     \
                  -min $tms_in_min [get_ports {altera_reserved_tms}]
}
...
proc set_tdi_timing_spec_when_driven_by_blaster { } {
  ...
  set tdi_header_trace_max      1.2
  set tdi_header_trace_min      0.1
  set tdi_in_max                [expr $tdi_cable_max        + \
                                      $tdi_header_trace_max + \
                                      $tdi_blaster_tco_max  - \
                                      [get_tck_delay_min]]
  set tdi_in_min                [expr $tdi_cable_min        + \
                                      $tdi_header_trace_min + \
                                      $tdi_blaster_tco_min  - \
                                      [get_tck_delay_max]]
  ...
  set_input_delay -add_delay -clock_fall -clock altera_reserved_tck     \
                  -max $tdi_in_max [get_ports {altera_reserved_tdi}]
  set_input_delay -add_delay -clock_fall -clock altera_reserved_tck     \
                  -min $tdi_in_min [get_ports {altera_reserved_tdi}]
}
...
proc set_tdi_timing_spec_when_driven_by_device { } {
  ...
  set tdi_trace_max                   1.2
  set tdi_trace_min                   0.1
  set tdi_in_max                      [expr $previous_device_tdo_tco_max + \
                                            $tdi_trace_max               - \
                                            [get_tck_delay_min]]
  set tdi_in_min                      [expr $previous_device_tdo_tco_min + \
                                            $tdi_trace_min               - \
                                            [get_tck_delay_max]]
...
proc set_tdo_timing_spec_when_drive_blaster { } {
  ...
  set tdo_header_trace_max            1.2
  set tdo_header_trace_min            0.1
  set tdo_out_max                     [expr $tdo_cable_max        + \
                                            $tdo_header_trace_max + \
                                            $tdo_blaster_tsu      + \
                                            [get_tck_delay_max]]
  set tdo_out_min                     [expr $tdo_cable_min        + \
                                            $tdo_header_trace_min - \
                                            $tdo_blaster_th       + \
                                            [get_tck_delay_min]]
  ...
  set_output_delay -add_delay -clock_fall -clock altera_reserved_tck      \
                   -max $tdo_out_max [get_ports {altera_reserved_tdo}]
  set_output_delay -add_delay -clock_fall -clock altera_reserved_tck      \
                   -min $tdo_out_min [get_ports {altera_reserved_tdo}]
}
...
proc set_tdo_timing_spec_when_drive_device { } {
  ...
  set tdo_trace_max                 1.2
  set tdo_trace_min                 0.1
  set tdo_out_max                   [expr $next_device_tdi_tco_max  + \
                                          $tdo_trace_max            + \
                                          [get_tck_delay_max]]
  set tdo_out_min                   [expr $next_device_tdi_tco_min  + \
                                          $tdo_trace_min            + \
                                          [get_tck_delay_min]]
